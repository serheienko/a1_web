...
import { PizzaCat } from "./pizza-cat";
      ...
      <header className="relative">
        ...
        <div className="mt-8 grid grid-cols-1 gap-px overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-200 sm:grid-cols-2 lg:grid-cols-4 dark:border-white/10 dark:bg-white/10">
          ...
          <Stat
            ...
            note={<T uk="половина має більше, половина менше. Рахуються всі публічні, разом із форками"
                     en="half have more, half have fewer. All public ones count, forks included"
                     ru="половина имеет больше, половина меньше. Считаются все публичные, включая форки"
                     de="die Hälfte hat mehr, die Hälfte weniger. Gezählt werden alle öffentlichen, Forks inklusive"
                     es="la mitad tiene más, la mitad menos. Cuentan todos los públicos, forks incluidos"
                     fr="la moitié en a plus, la moitié moins. Tous les dépôts publics comptent, forks inclus"
                     pl="połowa ma więcej, połowa mniej. Liczą się wszystkie publiczne, razem z forkami"
                     ptBR="metade tem mais, metade tem menos. Contam todos os públicos, forks inclusos"
                     zh="一半更多，一半更少。所有公开仓库都计入，包括 fork" />}
          />
        </div>
      </header>
